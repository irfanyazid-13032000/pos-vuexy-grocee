...
<h4 class="fw-bold py-3 mb-4">Data record bahan</h4>
    ...
    <form  method="GET">
        <div class="row mb-4">
            ...
            <div class="col-md-3">
                <input type="date" id="dateFrom" class="form-control" placeholder="Date From" value="{{ date('Y-m-d') }}" name="date_from">
            </div>
            <div class="col-md-3">
                <input type="date" id="dateTo" class="form-control" placeholder="Date To" value="{{ date('Y-m-d') }}" name="date_to">
            </div>

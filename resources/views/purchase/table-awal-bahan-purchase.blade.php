<table class="table table-bordered" id="table-bahan-purchase">
                                ...
                                <tr>
                                  <td>
                                    <select name="bahan_purcase[{{$i}}]bahan_dasar_id" id="bahan_dasar_id{{$i}}" class="form-control">
                                  ...
                                  <td><input type="number" class="form-control" name="bahan_purcase[{{$i}}]harga_satuan" id="harga_satuan{{$i}}"></td>
                                  <td><input type="number" class="form-control" name="bahan_purcase[{{$i}}]harga_acuan" id="harga_acuan{{$i}}" readonly></td>

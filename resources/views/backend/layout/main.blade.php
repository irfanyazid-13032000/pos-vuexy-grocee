...
<html
  ...
  <head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{url('assets/vendor/css/rtl/core.css')}}" class="{{ !request()->is('ingredient/*/edit/*') && !request()->is('warehouse-stock/*/edit/*') && !request()->is('warehouse-stock/*/*/raw-edit') ? 'template-customizer-core-css' : '' }}" />
    <link rel="stylesheet" href="{{url('assets/vendor/css/rtl/theme-default.css')}}" class="{{ !request()->is('ingredient/*/edit/*') && !request()->is('warehouse-stock/*/edit/*') && !request()->is('warehouse-stock/*/*/raw-edit') ? 'template-customizer-theme-css' : '' }}"  />
